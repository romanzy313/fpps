...
// export type Result<T, E extends StdErrType> =
//   | { ok: true; value: T; error?: never }
//   | { ok: false; value?: never; error: E };

// export const Ok = <T>(value: T): Result<T, never> => ({ ok: true, value });

// export const Err = <E extends StdErrType>(error: E): Result<never, E> => ({
//   ok: false,
//   error,
// });

// export const tryCatch = async <T, E extends StdErrType>(
